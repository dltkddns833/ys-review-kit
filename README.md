...
- **새 사례 등록**: `references/YYYY-MM-DD-<slug>.md` 파일 생성 후 (1) `SKILL.md`의 `## 참조 문서 안내` 테이블, (2) 이 README의 `## 참조 파일 구조` 블록, (3) 프로젝트 `CLAUDE.md`의 `## 파일 구조` → `references/` 목록에 **동시 추가**. 넷 중 하나라도 누락되면 영수님이 바로 짚음.
...
- **영수님 협업 가이드 원문**: `~/.claude/CLAUDE.md` (정본).
